...
export const FULL_AIRPORTS_LIST: Airport[] = [
  ...
  { code: 'LZO', name: '泸州云龙机场', city: '泸州', lat: 28.9892, lon: 105.4744, country: 'CN' },
  { code: 'NAO', name: '南充高坪机场', city: '南充', lat: 30.7931, lon: 106.1664, country: 'CN' },
  ...
  { code: 'KGT', name: '甘孜康定机场', city: '康定', lat: 30.1575, lon: 101.7347, country: 'CN' },
